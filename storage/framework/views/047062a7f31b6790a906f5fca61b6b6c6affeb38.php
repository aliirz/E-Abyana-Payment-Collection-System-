                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(url('LandRecord/add')); ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label font-weight-bold"><span>(12) </span>Length/طول (marla's)
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label font-weight-bold"><span>(13) </span>Width/عرض (marla's)</label>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    get_outlets(canalDropdown); // Call the function with the dropdown element
});

function get_outlets(element) {
    var canal_id = element.value;
    ...
    if (canal_id) {
        ...
        $('#outlet_id').empty();
        $('#outlet_id').append('<option value="">Choose Outlet</option>');
    }
}
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\durshal_cfp\abyana\resources\views/LandRecord/LandRecord.blade.php ENDPATH**/ ?>