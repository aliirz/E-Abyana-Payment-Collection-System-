...
<div class="app-content">
    ...
    <section class="section">
        ...
        <div class="page-header pt-0">
            <h4 class="page-title font-weight-bold">Add User</h4>
            <ol class="breadcrumb">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(url('AddUser/add')); ?>" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 mb-3">
                                <label  class="form-label font-weight-bold for="role_id">Select  Roles</label>
                                <select name="role_id" id="role_id" class="form-control" required>
                                    <option class="form-label font-weight-bold value="">Choose  Roles</option>
                                          ...
                                          <td><?php echo e($usersWithRole->user_name); ?></td>
                                            ...
                                            <td><?php echo e($usersWithRole->email); ?></td>
                                             <td><?php echo e($usersWithRole->phone_number); ?></td>
                                               <td><?php echo e($usersWithRole->password); ?></td>
                                                 <td><?php echo e($usersWithRole->role_name ?? 'No role assigned'); ?></td>
                                                   <td><?php echo e($usersWithRole->permission_name ?? 'No permission assigned'); ?></td>
  
                                        <td>
                                            <button class="btn btn-sm btn-primary badge" type="button" onclick="confirmDelete(<?php echo e($usersWithRole->id); ?>)">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2/resources/views/UserManagement/AddUser.blade.php ENDPATH**/ ?>