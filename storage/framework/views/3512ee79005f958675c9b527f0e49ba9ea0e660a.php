            ...
            <form class="form-horizontal" action="<?php echo e(url('AddIrragtor/add')); ?>" method="POST">
                ...
                <div class="row">
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">+ Add Irragtor</button>
                    </div>
                </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/abyana/resources/views/AddIrragtor.blade.php ENDPATH**/ ?>