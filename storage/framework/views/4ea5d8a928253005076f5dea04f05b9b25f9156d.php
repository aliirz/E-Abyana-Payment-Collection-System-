...
<!--Tempusdominus css-->
<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.css')); ?>">
<!--Datatables css-->
					...
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" alt="user-img" class="avatar-xl rounded-circle mb-1">
								<span class="pulse bg-success" aria-hidden="true"></span>
							</div>
							<div class="user-info">
								<h6 class=" mb-1 text-dark">ABYANA</h6>
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="<?php echo e(url('ListIrrigator')); ?>"><span> ListIrrigator</span></a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="<?php echo e(url('ListLandSurvey')); ?>"><span>List Land Survey</span></a></li>
							</ul>
						</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="<?php echo e(url('AddDivsion')); ?>"><span>Add Divsion/ڈویژن</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddDistrict')); ?>"><span>Add District(ضلع)</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddTahsil')); ?>"><span>Add Tahsil(تحصیل)</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddHalqa')); ?>"><span>Add Halqa/حلقہ</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddPatwari')); ?>"><span>Add Patwari/پٹواری</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddVillage')); ?>"><span>Village</span></a></li>
								<li><a class="slide-item" href="<?php echo e(url('AddCanal')); ?>"><span>Add Canal(نہر)</span></a></li>
								...
								<li><a class="slide-item" href="<?php echo e(url('Addprice')); ?>"><span>Add Crop Price</span></a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="<?php echo e(url('AssignRoles_Permission')); ?>"><span>Add AssignRoles</span></a></li>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2/resources/views/layout.blade.php ENDPATH**/ ?>