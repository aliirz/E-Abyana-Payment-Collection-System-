       ...
       <div class="col-md-6 col-sm-6 d-flex align-items-center">
            ...
            <div class="col-md-6 col-sm-6 text-right">
                <div class="form-inline" style="float:right;">
                    <div class="bill_date mr-2 text-center" style="height:62px; width:100px; border:1px solid gray;">
                      <p style="margin:0px;">بل کی تاریخ</p>
                      <p style="margin:0px;">Bill Date</p>
                      <p style="margin:0px;"><?php echo e($today); ?></p>
                    </div>
                    <div class="bill_due_date mr-4 text-center" style="height:62px; width:100px; border:1px solid gray;">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/abyana_new/abyana/resources/views/LandRecord/viewBill.blade.php ENDPATH**/ ?>