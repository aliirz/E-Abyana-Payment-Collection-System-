                ...
                <?php if(session('role_id')!=15 && session('role_id')!=16 && session('role_id')!=17): ?> 
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <?php if(session('role_id') == 12 || session('role_id') == 17 || session('role_id') == 1): ?> 
                                <li><a class="slide-item" href="<?php echo e(url('ListLandSurvey')); ?>"><span> List Survey</span></a></li>
                            <?php endif; ?>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="<?php echo e(url('ListIrrigatorsForApprovals')); ?>"><span> Approval's</span></a></li>
                  ...
                  <!--  <li class="slide">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="<?php echo e(route('AddVillage')); ?>"><span>Village</span></a></li>
                            <li><a class="slide-item" href="<?php echo e(route('AddCanal')); ?>"><span>Add Canal(نہر)</span></a>
                            </li>
                            <li><a class="slide-item" href="<?php echo e(route('CanalOutlet')); ?>"><span>OutLet</span></a></li>
                            <li><a class="slide-item" href="<?php echo e(route('AddCrop')); ?>"><span>Add Crop</span></a></li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/abyana_new/resources/views/layout.blade.php ENDPATH**/ ?>