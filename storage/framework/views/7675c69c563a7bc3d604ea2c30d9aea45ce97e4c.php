...
<div class="app-content">
    ...
    <div class="card shadow-sm w-[40vw]">
        <div class="card-header bg-primary flex justify-between text-white">
            <h4 class="font-weight-bold">Add </h4> <!-- Updated to reflect Employer data -->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/abyana_new/resources/views/RegionManagments/AddDistrict.blade.php ENDPATH**/ ?>