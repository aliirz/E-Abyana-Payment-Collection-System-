...
<div class="app-content">
    ...
    <section class="section">
        ...
        <div class="page-header pt-0">
            <h4 class="page-title font-weight-bold">District(ضلع)</h4>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" style="margin-top: 80px;">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="font-weight-bold">Add District(ضلع)</h4> <!-- Updated to reflect Employer data -->
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <select name="div_id" id="div_id" class="form-control" required>
                                    <option class="form-label font-weight-bold value="">Choose Divsion/ڈویژن</option>
                            ...
                            <div class="form-group col-lg-12">
                                <label class="form-label font-weight-bold">distric/ضلع</label>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2/resources/views/RegionManagments/AddDistrict.blade.php ENDPATH**/ ?>