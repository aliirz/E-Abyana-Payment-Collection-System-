            ...
            <aside class="app-sidebar">
                ...
                @if (session('role_id')!=15 && session('role_id')!=16 && session('role_id')!=17) 
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            @if (session('role_id') == 12 || session('role_id') == 17 || session('role_id') == 1) 
                                <li><a class="slide-item" href="{{ url('ListLandSurvey') }}"><span> List Survey</span></a></li>
                            @endif
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('ListIrrigatorsForApprovals') }}"><span> Approval's</span></a></li>
                  ...
                  <!--  <li class="slide">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ route('AddVillage') }}"><span>Village</span></a></li>
                            <li><a class="slide-item" href="{{ route('AddCanal') }}"><span>Add Canal(نہر)</span></a>
                            </li>
                            <li><a class="slide-item" href="{{ route('CanalOutlet') }}"><span>OutLet</span></a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('AssignRoles_Permission') }}"><span>Add AssignRoles</span></a></li>
