...
class IrrigatorController extends Controller
{
    ...
    //     ->select(
    //         'irrigators.id',                    // Include irrigator ID
    //         'irrigators.irrigator_name',        // Include irrigator_name
    //         'irrigators.irrigator_khata_number',// Include irrigator_khata_number
    //         'irrigators.irrigator_mobile_number', // Include irrigator_mobile_number
